<template>
          ...
          <span style="position: absolute; bottom: 0; right: 40%; transform: translateY(-50%); color: white; background-color: rgba(0, 0, 0, 0.5); padding: 5px; font-size: 20px; font-weight: bold;">Android</span>
          </router-link>
          </b-card>
          </div>
        <div>
